...
* Embedly: Used to show a bunch of different element using [Embedly API](http://embed.ly/) ([Examples](http://nyromodal.nyrodev.com/v2/embedly.php)) (depends on link). Embedly requires developers to sign up for an API key at [embed.ly/pricing](http://embed.ly/pricing).
